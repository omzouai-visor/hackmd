...
if (dbconfig.ssl) {
  if (dbconfig.ssl.keyFile) dbconfig.ssl.key = fs.readFileSync(dbconfig.ssl.keyFile)
  if (dbconfig.ssl.certFile) dbconfig.ssl.cert = fs.readFileSync(dbconfig.ssl.certFile)
  if (dbconfig.ssl.caFile) dbconfig.ssl.key = fs.readFileSync(dbconfig.ssl.caFile)
}
